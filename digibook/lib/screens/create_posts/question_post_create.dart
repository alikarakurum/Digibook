...
class QuestionPostCreatePage extends StatefulWidget {
  final UserOfApp user;

  QuestionPostCreatePage({this.user});

  @override
  _QuestionPostCreatePageState createState() => _QuestionPostCreatePageState();
}

class _QuestionPostCreatePageState extends State<QuestionPostCreatePage> {
